...
class AuthApiController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        {
            Auth::logout();
            return response()->json(['message' => 'user_blocked', 'error' => 'Tu cuenta ha sido bloqueada. Contacta al administrador.'], 423);
        }

        if ($user->id_role !== null && !$user->role?->isUser()) 
        {
            Auth::logout();
            return response()->json(['message' => 'role_not_allowed', 'error' => 'Esta cuenta solo puede iniciar sesión desde el panel web.'], 403);
        }

...
<x-layouts.admin :title="__('Editar plan')">
    <div class="mx-auto w-full max-w-xl p-6">
        ...
        <div class="flex items-center justify-between mb-6">
            <flux:heading level="2" size="xl" class="text-2xl !font-black text-black dark:text-white mb-5">
                Editar plan
            </flux:heading>
            
            <flux:button variant="ghost" icon="arrow-long-left" icon-variant="outline" :href="route('admin.plans.index')" wire:navigate>
                Regresar
            </flux:button>
        </div>
        ...
        <form method="POST" action="{{ route('admin.plans.update', $plan) }}" class="space-y-5">
            ...
            <div class="space-y-1">
                <flux:select name="type_view" label="Tipo de plan" class="w-full text-black dark:text-white" disabled>
            ...
            <div class="flex justify-end pt-2">
                <flux:button type="submit" variant="primary" icon="check-circle" icon-variant="outline"
